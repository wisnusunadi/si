...
class UjiLabDetail extends Model
{
    ...
    protected $fillable = ['no','no_sertifikat','uji_lab_id','detail_pesanan_produk_id','pemeriksa_id','noseri_id','no_sertifikat','tgl_masuk','tgl_kalibrasi','metode_id','status','is_ready','cetak_log','tf_log'];
