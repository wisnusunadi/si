...
class JadwalPerakitan extends Model
{
    ...
    protected $fillable = ['bulan','tgl_bppb','kode','tahun','no_urut','divisi_id','jenis','produk_id','no_bppb', 'jumlah', 'tanggal_mulai', 'tanggal_selesai', 'status', 'state', 'konfirmasi', 'warna', 'status_tf', 'created_at', 'keterangan', 'keterangan_transfer', 'evaluasi'];
