...
@section('content')
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select name="" id="produk_select" class="form-control produk_select"
                                            multiple>
    ...
    <!-- Modal -->
    <div class="modal fade modal_id" id="modal_id" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary cetakSeri">Cetak Nomor Seri</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Modal -->
    <div class="modal fade modalTableProduk" id="modelId" tabindex="-1" role="dialog"
    ...
    <!-- Modal Transfer Lain-->
    <div class="modal fade modalTransferLain" id="" tabindex="-1" role="dialog"
        aria-labelledby="modelTitleId" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade modalRakitProduk" id="" tabindex="-1" role="dialog"
        aria-labelledby="modelTitleId" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <button type="button" class="btn btn-primary btn-lg smallPaper">Kertas Kecil</button>
                    <button type="button" class="btn btn-primary btn-lg mediumPaper">Kertas Medium</button>
                </div>
            </div>
        </div>
    </div>
...
@section('adminlte_js')
    <script>
        ...
        $(document).on('click', '.detail', function() {
            var id = $(this).data('id');
            // implement data id on class cetakSeri
            $('.cetakSeri').data('id', id);
        ...
        $(document).on('click', '.cetakSeri', function() {
            let id = $(this).data('id');
            $('.mediumPaper').data('id', id);
            $('.smallPaper').data('id', id);
