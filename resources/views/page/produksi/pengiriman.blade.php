            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return '<button type="button" class="btn btn-outline-primary btn-sm detail" data-id="' + data + '"><i class="fas fa-edit"></i></button>&nbsp;<button type="button" class="btn btn-outline-danger btn-sm detail" data-id="' + data + '"><i class="fas fa-trash"></i></button>'
                    }
                }
            ],
            columnDefs: [{
