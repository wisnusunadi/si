        ...
        <div class="card card-primary card-outline card-outline-tabs col-lg-2">
                ...
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="custom-tabs-four-home-tab" data-toggle="pill"
                            ...
                            aria-selected="true">Pakai</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-four-profile-tab" data-toggle="pill"
                            href="#custom-tabs-four-profile" role="tab" aria-controls="custom-tabs-four-profile"
                            aria-selected="false">Masuk</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="tab-content" id="custom-tabs-four-tabContent">
                ...
                <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel"
                    aria-labelledby="custom-tabs-four-home-tab" style="height:215px">
                    <div class="card-header">
                ...
                <div class="tab-pane fade" id="custom-tabs-four-profile" role="tabpanel"
                    aria-labelledby="custom-tabs-four-profile-tab" style="height:215px">
...
@section('adminlte_js')
    ...
    <script type="text/javascript">
        ...
        function UpdateBarVolume() {
            $.ajax({
                url: '{{ $api_url }}' + "/air/rekap_volume_in",
                type: "get",
                success: function(res) {

                    for ($i = 0; $i < 7; $i++) {
                        // console.log(res.data[6].volume);
            ...
            $.ajax({
                url: '{{ $api_url }}' + "/air/rekap_volume_out",
                type: "get",
                success: function(res) {
        ...
        $(document).ready(function() {
            ...
            function updateGaugeIn() {
                $.ajax({
                    url: '{{ $api_url }}' + "/air/rekap_debit_in",
                    type: "get",
                    success: function(res) {
            ...
            function updateGaugeOut() {
                $.ajax({
                    url: '{{ $api_url }}' + "/air/rekap_debit_out",
                    type: "get",
                    success: function(res) {
        ...
        function kualitas() {
            $.ajax({
                url: '{{ $api_url }}' + "/air/rekap_kualitas",
                type: "get",
                success: function(res) {
