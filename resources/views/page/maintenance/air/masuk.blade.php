...
<script type="text/javascript">
    ...
    function UpdateBarVolume() {
        $.ajax({
            url: "http://localhost:8000/air/rekap_volume_in",
            type: "get",
        ...
        $.ajax({
            url: "http://localhost:8000/air/rekap_volume_out",
            type: "get",
            success: function(res) {
    ...
    $(document).ready(function() {
        ...
        function updateGaugeIn() {
            $.ajax({
                url: "http://localhost:8000/air/rekap_debit_in",
                type: "get",
                success: function(res) {
        ...
        function updateGaugeOut() {
            $.ajax({
                url: "http://localhost:8000/air/rekap_debit_out",
                type: "get",
                success: function(res) {
    ...
    function kualitas() {
        $.ajax({
            url: "http://localhost:8000/air/rekap_kualitas",
            type: "get",
            success: function(res) {
