                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="input-group input-group-sm mb-3">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text" id="inputGroup-sizing-sm">Kode
                                                            Panel</span>
                                                    </div>
                                                    <input type="text" name="kd_panel" id="kd_panel"
                                                        class="form-control" aria-label="Small"
                                                        aria-describedby="inputGroup-sizing-sm" require>
                                                </div>
                                                <div class="input-group input-group-sm mb-3">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text" id="inputGroup-sizing-sm">Nama
                                                            Panel</span>
                                                    </div>
                                                    <input type="text" name="nm_panel" id="nm_panel"
                                                        class="form-control" aria-label="Small"
                                                        aria-describedby="inputGroup-sizing-sm">
                                                </div>
                                                <div class="input-group input-group-sm mb-3">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text" id="inputGroup-sizing-sm">Posisi
                                                            Panel</span>
                                                    </div>
                                                ...
                                                <div class="input-group input-group-sm mb-3">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text" id="inputGroup-sizing-sm">Lokasi
                                                            Panel</span>
                                                    </div>
...
@section('adminlte_js')
    <script>
            ...
            let table = $('#tablePanel').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        data: null,
                        render: function(data, type, full, meta) {
                            return '<button type="button" class="btn btn-warning btnEdit" data-id="' + full
                                .device_id +
                                '">Ubah</button>&nbsp;<button type="button" class="btn btn-danger btnHapus" data-id="' +
                                full.device_id + '">Hapus</button>';
                        }
                    }
                ],
            });
        ...
        $(document).on('click', '.btnEdit', function() {
            ...
            $.ajax({
                type: 'get',
                url: '{{ $api_url }}' + '/listrik/ambilpanel?id=' + ids,
                success: function(data) {
