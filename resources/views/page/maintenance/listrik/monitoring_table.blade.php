                    ...
                    <div class="tab-content" id="pills-tab-1Content">
                        <div class="tab-pane fade show active" id="pills-home-1" role="tabpanel"
                            ...
                            <div class="row my-1">
                                <div class="col-12">
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button" id="ambil"
                            ...
                            <div class="row my-3">
                                ...
                                <div class="bc-warning text-warning px-auto py-2 ml-auto col-1" id="posisi"
                                    role="alert">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <table class="table" id="non_real">
                                            <thead class="thead-light">
                                                ...
                                                <tr>
                                                    ...
                                                    <th scope="col" style="vertical-align : middle;text-align:center;">
                                                        Voltage L-N (avg)</th>
                                                    <th scope="col" style="text-align: center">Active Power (total)
                                                    </th>
                                                    <th scope="col" style="text-align: center">Reactive Power (total)
                                                    </th>
                                                    <th scope="col" style="text-align: center">Apparent Power (total)
                                                    </th>
                                                    <th scope="col" style="text-align: center">Power Factor (total)
                                                    </th>
                                                    <th scope="col" style="text-align: center">Displacement Power
                                                        Factor
                                                        (total)</th>
                                                </tr>
                                            </thead>
...
@section('adminlte_js')
    <script>
                ...
                success: function(data) {
                    ...
                    for (a = 0; a < x; a++) {
                        $('#dropdownPanel').append(
                            '<a class="dropdown-item filter_device" data-value="' + data.data[a].device_id +
                            '" id="' + data.data[a].device_id + '">' + data.data[a].device_id + '</a>'
                        );
                    }
                    ...
                    $('.filter_device').click(function() {
                        ...
                        $.ajax({
                            type: 'get',
                            url: '{{ $api_url }}' + '/listrik/ambilraw?device_id=' + value,
                            success: function(data) {
                                ...
                                $('#val_apparent_total').html(data.data
        ...
        $(".filter_waktu").click(function() {
            ...
            $.ajax({
                type: 'get',
                url: '{{ $api_url }}' + '/listrik/data/' + value,
                success: function(data) {
                    // console.log(data);
                    $('#non_real').DataTable().ajax.url('{{ $api_url }}' + '/listrik/data/' +
                            value)
                        .load();
                }
            });
