            ...
            <div class="col-12">
                <table style="width:100%">
                    <tbody>
                        ...
                        <tr>
                            <td colspan="4"></td>
                            <td colspan="4" class="wb">Nuriyati</td>
                        </tr>
                        <tr>
                            <td colspan="4"></td>
                            <td colspan="4" class="wb">Jl Samudra Pasifik Gg X No 22</td>
                        </tr>
                        <tr>
                            <td colspan="4"></td>
                            <td colspan="4" class="wb">Pasuruan, Jawa Timur</td>
                        </tr>
                        <tr>
                            <td colspan="4"></td>
                ...
                <table class="table" border="1" style="border-collapse: collapse; text-align:center;" width="100%">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td class="align-right">112.00 pcs</td>
                            <td></td>
                        </tr>
                    </tfoot>
                </table>
