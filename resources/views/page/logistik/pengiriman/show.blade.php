                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-proses_kirim-tab" data-toggle="pill" href="#pills-proses_kirim" role="tab" aria-controls="pills-proses_kirim" aria-selected="true">Proses Kirim</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-selesai_kirim-tab" data-toggle="pill" href="#pills-selesai_kirim" role="tab" aria-controls="pills-selesai_kirim" aria-selected="false">Selesai Kirim</a>
                            </li>
                        </ul>
    ...
    $(function() {
        ...
        $(document).on('change', 'input[type="radio"][name="pengiriman"]', function(event) {
            ...
            if ($('input[type="radio"][name="pengiriman"]:checked').val() == "ekspedisi") {
                ...
                $('#no_polisi').val("");
                $('#nama_pengirim').val("");
                if ($('.ekspedisi_id').val() != "" && $('.ekspedisi_id').val() != null && ($('#no_invoice').val() != "" && !$('#no_invoice').hasClass('is-invalid'))) {
                    $('#btnsimpan').removeAttr('disabled');
                } else {
                    $('#btnsimpan').attr('disabled', true);
                }
                ...
                if ($('#nama_pengirim').val() != "" && ($('#no_invoice').val() != "" && !$('#no_invoice').hasClass('is-invalid'))) {
                    $('#btnsimpan').removeAttr('disabled');
                } else {
                    $('#btnsimpan').attr('disabled', true);
                }
