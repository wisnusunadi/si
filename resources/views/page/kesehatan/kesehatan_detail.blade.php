            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group row">
                        <label for="no_pemeriksaan" class="col-sm-4 col-form-label" style="text-align:right;">Nama
                            Karyawan</label>
                        <div class="col-sm-8">
                            <select type="text" class="form-control @error('divisi') is-invalid @enderror select2"
                        ...
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle"
                                    src="{{ url('assets/image/user') }}/index.png" alt="User profile picture">
                            </div>
                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                <li class="nav-item"><a class="nav-link active" href="#berat" data-toggle="tab"><i
                                            class="fas fa-weight"></i> Berat badan</a></li>
                                <li class="nav-item"><a class="nav-link" href="#vaksin" data-toggle="tab"><i
                                            class="fas fa-syringe"></i> Riwayat vaksin</a></li>
                                <li class="nav-item"><a class="nav-link" href="#penyakit" data-toggle="tab"><i
                                            class="fas fa-head-side-cough"></i> Riwayat penyakit</a></li>
                                <li class="nav-item"><a class="nav-link" href="#obat" data-toggle="tab"><i
                                            class="fas fa-tablets"></i> Riwayat permintaan obat</a></li>
                            </ul>
                        </div><!-- /.card-header -->
                        <div class="card-body">
