...
@section('content')
                        ...
                        <table id="tabel" class="table table-hover styled-table table-striped">
                            <thead style="text-align: center;">
                                @if (Auth::user()->divisi_id == '28')
                                    <tr>
                                        <th colspan="12">
                                            <a href="/karyawan/masuk/tambah" style="color: white;"><button type="button"
    ...
    <!-- Modal Detail -->
    <div class="modal fade  bd-example-modal-lg" id="riwayat_mod" tabindex="-1" role="dialog"
    ...
    <script>
        $(function() {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            var btn =
                                '<span class="m-1"><button type="button" id="delete" class="btn btn-sm btn-danger" data-id="' +
                                row.id + '"><i class="fas fa-trash"></i> Hapus</button></span>';
            ...
            $('#tabel > tbody').on('click', '#riwayat', function() {
                ...
                var diagnosa = rows[0]['karyawan_sakit']['diagnosa'] != null ? rows[0]['karyawan_sakit'][
                    'diagnosa'
                ] : '<i>Tidak Ada Diagnosa</i>';
                var analisa = rows[0]['karyawan_sakit']['analisa'] != null ? rows[0]['karyawan_sakit'][
                    'analisa'
                ] : '<i>Tidak Ada Analisa</i>';
