        ...
        <div class="card-body">
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-data" role="tabpanel" aria-labelledby="pills-data-tab">
                    ...
                    <div class='table-responsive'>
                        <table id="berat_tabel_data" class="table table-hover styled-table table-striped" style="display:none">
                            <thead style="text-align: center;">
                            <tr>
                                <th colspan="16">
                                <a href="/kesehatan/bulanan/berat/tambah" style="color: white;"><button type="button" class="btn btn-block btn-success btn-sm" style="width: 200px;"><i class="fas fa-plus"></i> &nbsp; Tambah</i></button></a>
                        ...
                        <table id="gcu_tabel_data" class="table table-hover styled-table table-striped" style="display:none">
                            <thead style="text-align: center;">
                            <tr>
                                <th colspan="12">
                                <a href="/kesehatan/bulanan/gcu/tambah" style="color: white;"><button type="button" class="btn btn-block btn-success btn-sm" style="width: 200px;"><i class="fas fa-plus"></i> &nbsp; Tambah</i></button></a>
                        ...
                        <div class="col-lg-6">
                            <form action="/kesehatan/harian/aksi_tambah" method="post">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class='table-responsive'>
                                            <table id="berat_tabel" class="table table-hover styled-table table-striped" style="width:100%;">
                                                <thead>
                                                    <tr>
                                                        <th>No</th>
                                                        <th>Bulan</th>
...
>>>>>>> 08617274c58c3c7355f120df7f17438716251e2c
        </div>
    </div>
  </div>
</div>
...
>>>>>>> 08617274c58c3c7355f120df7f17438716251e2c
                    ...
                    <div class="form-horizontal">
                        <div class="card card-outline card-warning">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="tgl_cek" class="col-lg-5 col-form-label align-right">Berat & Lemak</label>
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control d-none" name="id" id="id">
                                        <div class="row">
                                            <div class="input-group col-6">
                                                <input type="text" class="form-control berat" name="berat" id="berat" placeholder="Berat">
                                                <div class="input-group-append">
                                                    <span class="input-group-text">Kg</span>
                                                </div>
                                            </div>
                                            <div class="input-group col-6">
                                                <input type="text" class="form-control lemak" name="lemak" id="lemak" placeholder="Lemak">
                                                <div class="input-group-append">
                                ...
                                <div class="form-group row">
                                    <label for="tgl_cek" class="col-lg-5 col-form-label align-right">Kandungan Air</label>
                                    <div class="input-group col-lg-2">
                                        <input type="text" class="form-control kandungan_air" name="kandungan_air" id="kandungan_air" placeholder="Air">
                                        <div class="input-group-append">
                                ...
                                <div class="form-group row">
                                    <label for="tgl_cek" class="col-lg-5 col-form-label align-right">Otot & Tulang</label>
                                    <div class="col-lg-4">
                                        <div class="row">
                                            <div class="input-group col-6">
                                                <input type="text" class="form-control otot" name="otot" id="otot" placeholder="Otot">
                                                <div class="input-group-append">
                                                    <span class="input-group-text">Kg</span>
                                                </div>
                                            </div>
                                            <div class="input-group col-6">
                                                <input type="text" class="form-control tulang" name="tulang" id="tulang" placeholder="Tulang">
                                                <div class="input-group-append">
                                                    <span class="input-group-text">Kg</span>
                                                </div>
                                            </div>
                                ...
                                <div class="form-group row">
                                    <label for="tgl_cek" class="col-lg-5 col-form-label align-right">Kalori</label>
                                    <div class="input-group col-2">
                                        <input type="text" class="form-control kalori" name="kalori" id="kalori" placeholder="Kalori">
                                        <div class="input-group-append">
                                ...
                                <div class="form-group row">
                                    <label for="catatan" class="col-lg-5 col-form-label align-right">Catatan</label>
                                    <div class="col-lg-4">
                            ...
                            <div class="card-footer">
                                ...
                                <button class="btn btn-warning float-right" id="button_tambah" onclick="return confirm('Data akan di ubah ?');">Simpan</button>
                            </div>
                        </div>
                    </div>
    ...
    <form method="post" action="/kesehatan/bulanan/gcu/aksi_ubah">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="card card-outline card-warning">
                <div class="card-header"><h6 class="card-title">GCU</h6></div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <div class="form-horizontal">
                                <div class="form-group row">
                                    <input type="text" class="form-control d-none" name="id" id="id">
                                    <label for="glukosa" class="col-lg-4 col-md-12 col-form-label align-right">Glucose</label>
                                    <div class="input-group col-lg-4">

                                        <input type="text" class="form-control glukosa" name="glukosa" id="glukosa" placeholder="Glucose">
                                        <div class="input-group-append">
                                ...
                                <div class="form-group row">
                                    <label for="kolesterol" class="col-lg-4 col-md-12 col-form-label align-right">Cholestrol</label>
                                    <div class="input-group col-lg-4">
                                        <input type="text" class="form-control kolesterol" name="kolesterol" id="kolesterol" placeholder="Cholestrol">
                                        <div class="input-group-append">
                                            <span class="input-group-text">mg/dl</span>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label for="asam_urat" class="col-lg-4 col-md-12 col-form-label align-right">Uric ACID</label>
                                    <div class="input-group col-lg-4" >
                                        <input type="text" class="form-control asam_urat" name="asam_urat" id="asam_urat" placeholder="Uric ACID">
                                        <div class="input-group-append">
                                            <span class="input-group-text">mg/dl</span>
                                        </div>
                                    </div>
