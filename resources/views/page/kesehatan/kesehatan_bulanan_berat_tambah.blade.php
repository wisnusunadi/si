        ...
        <div class="col-12">
                ...
                <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-2">
                                        <input type="date" class="form-control tgl_cek_form col-form-label"
                                            name="tgl_cek_form" id="tgl_cek_form" max="{{ date('Y-m-d') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="tgl_cek_form" class="col-lg-5 col-form-label align-right">Nama
                                        Karyawan</label>
                                    <div class="col-lg-3">
                    ...
                    <div class="row mt-3">
                        <div class="col-6">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group row">
                                    <label for="tgl_cek_form" class="col-lg-3 col-form-label align-right">Berat &
                                        Lemak</label>
                                    <div class="col-lg-6">
                                        <div class="row">
                                            <div class="input-group col-6">
                                                <input type="text" class="form-control berat_form" name="berat_form"
                                                    id="berat_form" placeholder="Berat">
                                                <div class="input-group-append">
                                                    <span class="input-group-text">Kg</span>
                                                </div>
                                            </div>
                                            <div class="input-group col-6">
                                                <input type="text" class="form-control lemak_form" name="lemak_form"
                                                    id="lemak_form" placeholder="Lemak">
                                                <div class="input-group-append">
                                ...
                                <div class="form-group row">
                                    <label for="tgl_cek_form" class="col-lg-3 col-form-label align-right">Kandungan
                                        Air</label>
                                    <div class="input-group col-lg-4">
                                        <input type="text" class="form-control kandungan_air_form"
                                            name="kandungan_air_form" id="kandungan_air_form" placeholder="Air">
                                        <div class="input-group-append">
                                ...
                                <div class="form-group row">
                                    <label for="tgl_cek_form" class="col-lg-3 col-form-label align-right">Otot &
                                        Tulang</label>
                                    <div class="col-lg-6">
                                        <div class="row">
                                            <div class="input-group col-6">
                                                <input type="text" class="form-control otot_form" name="otot_form"
                                                    id="otot_form" placeholder="Otot">
                                                <div class="input-group-append">
                                                    <span class="input-group-text">Kg</span>
                                                </div>
                                            </div>
                                            <div class="input-group col-6">
                                                <input type="text" class="form-control tulang_form" name="tulang_form"
                                                    id="tulang_form" placeholder="Tulang">
                                                <div class="input-group-append">
                                                    <span class="input-group-text">Kg</span>
                                                </div>
                                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="input-group col-4">
                                        <input type="text" class="form-control kalori_form" name="kalori_form"
                                            id="kalori_form" placeholder="Kalori">
                                        <div class="input-group-append">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group row">
                                    <label for="keterangan" class="col-sm-3 col-form-label"
                                        style="text-align:right;">Suhu</label>
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group row">
                                    <label for="keterangan" class="col-sm-3 col-form-label"
                                        style="text-align:right;">Saturasi Oksigen Darah</label>
                                    <div class="col-sm-6">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="spo2_form"
                                                        id="spo2_form" value="{{ old('spo2_form') }}" placeholder="SPO2">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">%</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="pr_form"
                                                        id="pr_form" value="{{ old('pr_form') }}" placeholder="PR">
                                                    <div class="input-group-append">
                                ...
                                <div class="form-group row">
                                    <label for="keterangan" class="col-sm-3 col-form-label"
                                        style="text-align:right;">Tekanan Darah</label>
                                    <div class="col-sm-6">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="sistolik_form"
                                                        id="sistolik_form" value="{{ old('sistolik_form') }}"
                                                        placeholder="Systol">
                                                    <div class="input-group-append">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="diastolik_form"
                                                        id="diastolik_form" value="{{ old('diastolik_form') }}"
                                                        placeholder="Dyastol">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">mmHg</span>
                                                    </div>
            ...
            <form action="/kesehatan/bulanan/berat/aksi_tambah" method="post" enctype="multipart/form-data">
                ...
                <div class="card card-outline card-info">
                    ...
                    <div class="card-footer">
                        <a href="/kesehatan/bulanan"><button type="button" class="btn btn-danger btn-sm"
                                id="btnreset">Batal</button></a>
                        <button type="submit" class="btn btn-info btn-sm float-right" id="tambahitem">Simpan
                            Data</button>
                    </div>
                </div>
            </form>
        ...
        $(function() {
            ...
            $('#tambahitem').click(function(e) {
                ...
                <td><input type="text" class="form-control d-none karyawan_id" name="karyawan_id[]" value="` +
                    karyawan_id_form + `">` + karyawan_text_form + `</td>
                <td><input type="text" class="form-control d-none berat" name="berat[]" value="` + berat_form + `">` +
                    berat_form + ` Kg</td>
                <td><input type="text" class="form-control d-none lemak" name="lemak[]" value="` + lemak_form + `">` +
                    lemak_form + ` gram</td>
                <td><input type="text" class="form-control d-none kandungan_air" name="kandungan_air[]" value="` +
                    kandungan_air_form + `">` + kandungan_air_form + `%</td>
                <td><input type="text" class="form-control d-none otot" name="otot[]" value="` + otot_form + `">` +
                    otot_form + ` Kg</td>
                <td><input type="text" class="form-control d-none tulang" name="tulang[]" value="` + tulang_form +
                    `">` + tulang_form + ` Kg</td>
                <td><input type="text" class="form-control d-none kalori" name="kalori[]" value="` + kalori_form +
                    `">` + kalori_form + ` kkal</td>
                <td><input type="text" class="form-control d-none suhu" name="suhu[]" id="suhu"  value="` + suhu_form +
                    `">` + suhu_form + ` °C</td>
                <td><input type="text" class="form-control d-none spo2" name="spo2[]" id="spo2" value="` + spo2_form +
                    `">` + spo2_form + `%</td>
                <td><input type="text" class="form-control d-none pr" name="pr[]" id="pr" value="` + pr_form + `">` +
                    pr_form + ` bpm</td>
                <td><input type="text" class="form-control d-none sistolik" name="sistolik[]" id="sistolik" value="` +
                    sistolik_form + `">` + sistolik_form +
                    ` mmHg</td>
                <td><input type="text" class="form-control d-none diastolik" name="diastolik[]" id="diastolik" value="` +
                    diastolik_form + `">` +
                    diastolik_form + ` mmHg</td>
                ...
                if (tgl_cek_form != '' && berat_form !=
                    '' && lemak_form != '' &&
                    kandungan_air_form !=
                    '' && otot_form != '' && tulang_form != '' && kalori_form != '' && suhu_form != '' &&
                    spo2_form != '' && pr_form != '' && sistolik_form != '' && diastolik_form != ''
                ) {

                    $('#tgl_cek_form').val('');
                    // $('#karyawan_id_form').val('').trigger('change');
                    $('#berat_form').val('');
                    $('#lemak_form').val('');
                    $('#kandungan_air_form').val('');
                    $('#otot_form').val('');
