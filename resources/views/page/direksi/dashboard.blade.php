                                                ...
                                                <div class="row">
                                                            ...
                                                            <div class="col-lg-12 col-xl-6 py-2">
                                                                <div class="card h-100 purple">
                                                                    ...
                                                                    <div class="card-footer align-center"><a href="#"
                                                                            id="belumdikirim" class="link">Lihat Laporan
                                                            ...
                                                            <div class="col-lg-12 col-xl-6 py-2">
                                                                <div class="card h-100 yellow">
                                                                    ...
                                                                    <div class="card-footer align-center"><a
                                                                            href="/qc/so/show" id="belumdikirim"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12 col-xl-6 py-2">
                                                                <div class="card h-100 green">
                                                                    ...
                                                                    <div class="card-footer align-center">
                                                                        <a href="/logistik/so/show" id="belumdikirim"
                                                                            class="link">Lihat Laporan <i
                                                                                class="fas fa-arrow-circle-right"></i></a>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-12 col-xl-6 py-2">
                                                                <div class="card h-100 midnightblue">
                                                                    ...
                                                                    <div class="card-footer align-center"><a
                                                                            href="/dc/so/show" id="belumdikirim"
                                                                            class="link">Lihat Laporan <i
                                                                                class="fas fa-arrow-circle-right"></i></a>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="col-lg-12 col-12 py-2"> --}}
                                                        <div class="card h-100 red">
                                                            ...
                                                            <div class="card-footer align-center">
                                                                <a href="/penjualan/penjualan/show" id="belumdikirim"
                                                                    class="link">Lihat Laporan <i
                                                                        class="fas fa-arrow-circle-right"></i></a>
                                                            </div>
                                                        </div>
