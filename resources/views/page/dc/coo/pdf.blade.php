            ...
            <table border="0" class="table" style="border-collapse: collapse;" width="100%">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="wb vera"><b>KEMENKES RI AKD 2050228080267</b></td>
                    </tr>
                    <tr>
                ...
                <table border="0" style="width:100%" id="produktable">
                    <tbody>
                        ...
                        <tr class="vera bold">
                            ...
                            <td class="wb">RGB MEDICAL BLOOD PRESSURE MONITOR/
                                TENSIMETER DIGITAL BPM001 PLUS ADAPTOR</td>
                        </tr>
                        <tr class="vera bold">
                            <td style="width:2%"></td>
                        ...
                        <tr class="vera bold">
                            ...
                            <td class="nospace align-center"> : </td>
                            <td class="wb">RGB0124924819</td>
                        </tr>
                        <tr class="vera bold">
                            <td style="width:2%"></td>
                            <td class="nospace trheight">Merk Produk</td>
                            <td class="nospace align-center"> : </td>
                            <td class="wb">ELITECH</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="row mdtxt">
            <table border="0" class="table align-center" width="100%" style="border-collapse: collapse;">
                <tbody>
                    ...
                    <tr>
                        <td class="wb">
                            <b>Pemerintah Daerah Kabupaten Sumba Barat Daya</b>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="row mdtxt">
            <table border="0" class="table align-center" width="100%" style="border-collapse: collapse;">
                <tbody>
                    ...
                    <tr>
                        <td class="wb"><b>AK1-P2109-4302254</b></td>
                    </tr>
                    <tr style="min-height: 20px; max-height: 65px;">
                        <td class="wb">
                            <b class="font-size:auto;">Pengadaan Inkubator untuk Ruang NICU RSUD Majalengka Penguatan Alat Kesehatan Pelayanan Ibu dan Anak RS PONEK (DAK) Belanja Modal Alat Kedokteran Anak Kegiatan Penyediaan Fasilitas Pelayanan Kesehatan untuk UKM dan UKP Kewenangan Daerah Kabupaten/Kota Sub</b>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="row mdtxt">
            <table border="0" class="table align-center" width="100%">
                <tbody>
                    <tr>
                        <td width="50%"></td>
                        <td class="align-center">Surabaya, 07 Oktober 2021</td>
                    </tr>
                    <tr>
                        <td width="50%"></td>
                    ...
                    <tr>
                        <td width="50%"></td>
                        <td class="align-center"><b><u>Kusmardiana Rahayu</u></b></td>
                    </tr>
                    <tr>
                        <td width="50%"></td>
                        <td class="align-center">Q.A. Manager</td>
                    </tr>
                </tbody>
            </table>
        </div>
