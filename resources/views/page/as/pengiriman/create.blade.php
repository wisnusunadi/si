                                    ...
                                    <div class="card card-outline card-primary">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <select name="no_retur" id="no_retur"
                                                    class="no_retur form-control custom-select text-sm"></select>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-md-8">
                                                    ...
                                                    <div class="form-check form-check-inline mt-1">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="pilih_penerima" value="customer">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-4 col-md-8">
                                                    <input type="text" name="telp_penerima" id="telp_penerima"
                                                        class="telp_penerima form-control" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
