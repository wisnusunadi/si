                        ...
                        <div class="content">
                            ...
                            <div class="row">
                                <div class="col-lg-7 col-md-6">
                                    <div class="card">
                                        <div class="card-header"><h6 class="card-title">Tambah PO</h6></div>
                                        <div class="card-body">
                                            <form action="{{route('penjualan.so.ekatalog.create', ['id' => $ekatalog->id])}}" method="post">
                                                ...
                                                <div class="form-horizontal">
                                                    <div class="form-group row">
                                                        <label for="no_po" class="col-lg-4 col-md-12 col-form-label labelket">No PO</label>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="tanggal_po" class="col-lg-4 col-md-12 col-form-label labelket">Tanggal PO</label>
                                                        <div class="col-lg-5 col-md-12">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="" class="col-form-label col-lg-4 col-md-12 labelket">Delivery Order</label>
                                                    ...
                                                    <div class="form-group row hide" id="do_detail_no">
                                                        <label for="" class="col-form-label col-lg-4 col-md-12 labelket">Nomor DO</label>
                                                        <div class="col-lg-5 col-md-12">
                                                    ...
                                                    <div class="form-group row hide" id="do_detail_tgl">
                                                        <label for="" class="col-form-label col-lg-4 col-md-12 labelket">Tanggal DO</label>
                                                        <div class="col-lg-5 col-md-12">
