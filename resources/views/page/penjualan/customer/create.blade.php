                                            ...
                                            <div class="card-body">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-md-12">
                                                        <input type="text"
                                                            class="form-control col-form-label @error('nama_customer') is-invalid @enderror"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-6 col-md-12">
                                                        <input type="text"
                                                            class="form-control col-form-label @error('email') is-invalid @enderror"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-5 col-md-12">
                                                        <select
                                                            class="select-info form-control col-form-label custom-select provinsi @error('alamat') is-invalid @enderror"
                                                            name="provinsi" id="provinsi" width="100%">
                                                        </select>
                                                ...
                                                <div class="form-group row">
                                                    <label for="telepon"
                                                        class="col-lg-4 col-md-12 col-form-label labelket">No Telp</label>
                                                    <div class="col-lg-5 col-md-12">
                                                        <input type="text"
                                                            class="form-control col-form-label @error('telepon') is-invalid @enderror"
                                                ...
                                                <div class="form-group row hide">
                                                    ...
                                                    <div class="col-lg-5 col-md-12">
                                                        <input type="text"
                                                            class="form-control col-form-label @error('pemilik') is-invalid @enderror"
                                                            placeholder="Nama Pemilik" id="pemilik" name="pemilik" />
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="card card-outline card-info">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group row">
                                                    <label for="pic"
                                                        class="col-lg-4 col-md-12 col-form-label labelket">PIC</label>
                                                    <div class="col-lg-5 col-md-12">
                                                        <input type="text"
                                                            class="form-control col-form-label @error('pic') is-invalid @enderror"
                                                            placeholder="Nama PIC" id="pic" name="pic" />
                                                ...
                                                <div class="form-group row">
                                                    <label for="ktp"
                                                        class="col-lg-4 col-md-12 col-form-label labelket">No KTP</label>
                                                    <div class="col-lg-5 col-md-12">
                                                        <input type="text"
                                                            class="form-control col-form-label @error('ktp') is-invalid @enderror"
                                                            value="" placeholder="Masukkan KTP" id="ktp"
                                                            name="ktp" />
                                                ...
                                                <div class="form-group row">
                                                    <label for="npwp"
                                                        class="col-lg-4 col-md-12 col-form-label labelket">NPWP</label>
                                                    <div class="col-lg-5 col-md-12">
                                                        <input type="text"
                                                            class="form-control col-form-label @error('npwp') is-invalid @enderror"
                                                            value="" placeholder="Masukkan NPWP" id="npwp"
                                                            name="npwp" />
                                                ...
                                                <div class="form-group row">
                                                    <label for="batas"
                                                        class="col-form-label col-lg-4 col-md-12 labelket">Batas
                                                        Pembayaran</label>
                                                    <div class="col-lg-4 col-md-6 input-group">
                                                        <input type="text"
                                                            class="form-control col-form-label @error('batas') is-invalid @enderror"
                                                            name="batas" id="batas" aria-label="batas"
                                                            placeholder="Batas hari pembayaran" />
                                                ...
                                                <div class="form-group row hide">
                                                    <label for="izin_usaha"
                                                        class="col-lg-4 col-md-12 col-form-label labelket">Izin
                                                        Usaha</label>
                                                    <div class="col-lg-8 col-md-11 col-form-label">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                name="izin_usaha" id="izin_usaha1" value="IUMK"
                                                                data-toggle="iumk_info" title="merge" />
                                                            <label class="form-check-label" for="izin_usaha1">IUMK</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                name="izin_usaha" id="izin_usaha2" value="IUTM"
                                                                data-toggle="iutm_info" title="merge" />
                                                            <label class="form-check-label" for="izin_usaha2">IUTM</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                name="izin_usaha" id="izin_usaha3" value="SIUP"
                                                                data-toggle="siup_info" title="merge" />
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group row hide">
                                                    <label for="modal_usaha"
                                                        class="col-lg-4 col-md-12 col-form-label labelket">Modal
                                                        Usaha</label>
                                                    <div class="col-lg-8 col-md-11 col-form-label">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                name="modal_usaha" id="modal_usaha1" value="1" />
                                                            <label class="form-check-label" for="modal_usaha1">
                                                                < 1 M </label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                name="modal_usaha" id="modal_usaha2" value="2" />
                                                            <label class="form-check-label" for="modal_usaha2"> > 1 M & <
                                                                    5 M </label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                name="modal_usaha" id="modal_usaha3" value="3" />
                                                            <label class="form-check-label" for="modal_usaha3"> > 5 M & <
                                                                    10 M </label>
                                                        </div>
                                                ...
                                                <div class="form-group row hide">
                                                    <label for="hasil_penjualan"
                                                        class="col-lg-4 col-md-12 col-form-label labelket">Hasil
                                                        Penjualan</label>
                                                    <div class="col-lg-8 col-md-11 col-form-label">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                name="hasil_penjualan" id="hasil_penjualan1"
                                                                value="1" />
                                                            <label class="form-check-label" for="hasil_penjualan1">
                                                                < 2 M </label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                name="hasil_penjualan" id="hasil_penjualan2"
                                                                value="2" />
                                                            <label class="form-check-label" for="hasil_penjualan2"> > 2 M
                                                                & < 15 M </label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                name="hasil_penjualan" id="hasil_penjualan3"
                                                                value="3" />
                                                            <label class="form-check-label" for="hasil_penjualan3"> > 15 M
                                                                & < 50 M </label>
                                                        </div>
                                ...
                                <div class="form-group row">
                                    <span class="float-left col-6">
                                        <a type="button" class="btn btn-danger"
                                            href="{{ route('penjualan.customer.show') }}">
                                            Batal
                                        </a>
                                    </span>
