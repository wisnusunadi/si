                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-8 labelinfo">
                                    ...
                                    @if (isset($customer->nama_pemilik))
                                        <div class="margin-all"><a class="text-muted margin-side">Pemilik
                                                :</a><b>{{ $customer->nam_pemilik }}</b></div>
                                    @endif
                                    ...
                                    <div class="margin-all"><a class="text-muted margin-side">NPWP
                                            :</a><b>{{ $customer->npwp }}</b></div>
                                    <div class="margin-all hide">
                                        <span><a class="text-muted margin-side">IZIN USAHA :</a><b class="badge blue-text">
                                                @if (isset($customer->izin_usaha))
                                                    {{ $customer->izin_usaha }}
                                                @else
                                                    -
                                                @endif
                                        ...
                                        |<span>
                                            <a class="text-muted margin-side">HASIL PENJUALAN :</a><b
                                                class="badge blue-text">
