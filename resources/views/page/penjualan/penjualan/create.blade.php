                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" id="create_penjualan" autocomplete="off"
                                action="{{ route('penjualan.penjualan.store') }}">
                                {{ csrf_field() }}
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-lg-6 col-md-12 col-form-label">
                                                                            <select name="ekspedisi" id="ekspedisi"
                                                                                class="form-control ekspedisi"></select>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-6 col-md-12 col-form-label">
                                                                        <select name="ekspedisi" id="ekspedisi_nonakn"
                                                                            class="form-control ekspedisi_nonakn"></select>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row d-none">
                                                                    <label for=""
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="custom-control custom-switch">
                                                                                <input type="checkbox"
                                                                                    class="custom-control-input-kalibrasi custom-control-input produk_kalibrasi"
                                                                                    id="produk_kalibrasi0"
                                                                                    name="produk_kalibrasi[0]"
                                                                                    value="0" disabled>
                                                                                <label
                                                                                    class="custom-control-label-kalibrasi custom-control-label produk_kalibrasi_label"
                                                                ...
                                                                <tfoot>
                                                                    <tr>
                                                                        <th colspan="100%" class="text-right">
                                                                            Total Harga
                                                                            <span id="totalhargaprd">Rp. 0</span>
                                                                        </th>
                                                                    </tr>
                                                                </tfoot>
                                                            </table>
                                                                ...
                                                                <tfoot>
                                                                    <tr>
                                                                        <th colspan="100%" class="text-right">Total
                                                                            Harga
                                                                            <span id="totalhargapart">Rp. 0</span>
                                                                        </th>
                                                                    </tr>
                                                                </tfoot>
                                                            </table>
            ...
            $.ajax({
                ...
                success: function(response) {
                    swal.fire(
                        ...
                        response.pesanan_id != 'refresh' ? showalertcetaksppb(response
                            .pesanan_id) : window.location.reload();
        ...
        $(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data[0] != undefined) {
                            ...
                            const pilihan_pengiriman = $(
                                'input[name="pilihan_pengiriman"]:checked').val();
                            ...
                            const pilihan_pengiriman_nonakn = $(
                                'input[name="pilihan_pengiriman_nonakn"]:checked').val();
            ...
            function transferproduk(id, nama_produk, produk_id, jumlah, harga) {
                var data = `<tr>
                    ...
                    <td>
                    <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input custom-control-input-pajak produk_ppn" id="produk_ppn0" name="produk_ppn[0]" value="0" checked>
            ...
            function trproduktable() {
                ...
                <td>
                <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input custom-control-input-pajak produk_ppn" id="produk_ppn0" name="produk_ppn[0]" value="1" checked>
                        <label class="custom-control-label custom-control-label-pajak produk_ppn_label" for="produk_ppn0">PPN</label>
                        </div>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input custom-control-input-pajak part_ppn" id="part_ppn0" name="part_ppn[0]" value="1" checked>
            ...
            <tr>
                ...
                <td>
                    <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input custom-control-input-pajak jasa_ppn" id="jasa_ppn0" name="jasa_ppn[0]" value="1" checked>
                        <label class="custom-control-label custom-control-label-pajak jasa_ppn_label" for="jasa_ppn0">PPN</label>
                        </div>
                </td>
                <td>
