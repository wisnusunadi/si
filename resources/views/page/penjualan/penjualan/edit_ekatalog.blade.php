                                                                        ...
                                                                        @if ($e->status == 'draft' || $e->status == 'batal')
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="input-group-append  @if ($e->status == 'sepakat' || $e->status == 'negosiasi') hide @endif"
                                                                                        id="checkbox_nopaket">
                        ...
                        function numberRowsProduk($t) {
                            ...
                            $t.find("tr").each(function(ind, el) {
                                ...
                                for (var k = 0; k < variasi.length; k++) {
                                    ...
                                    $(el).find('select[data-attr="variasi' + k + '"]').attr('name', 'variasi[' +
                                        j +
                                        '][' + k + ']');
                                    $(el).find('select[data-attr="variasi' + k + '"]').attr('id', 'variasi' +
                                        j + '' +
                                        k);
                                    $(el).find('span[data-attr="ketstok' + k + '"]').attr('name', 'ketstok[' +
                                        j +
                                        '][' + k + ']');
                                    $(el).find('span[data-attr="ketstok' + k + '"]').attr('id', 'ketstok' + j +
                                        '' + k);
                                }
                            ...
                            if (jumlah != "" && harga != "") {
                                ...
                                for (var i = 0; i < variasi.length; i++) {
                                    ...
                                    if (cek_stok(variasires.id) < kebutuhan) {
                                        ...
                                        $('select[name="variasi[' + ppid + '][' + i + ']"]').removeClass(
                                            'is-invalid');
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(res) {
                                            for (var x = 0; x < res[0].produk.length; x++) {
                                                ...
                                                if (res[0].produk[x].gudang_barang_jadi.length <= 1) {
                                                    data.push({
                                                        id: res[0].produk[x].gudang_barang_jadi[0]
                                                            .id,
                                                        text: res[0].produk[x].nama,
                                                        jumlah: res[0].produk[x].pivot.jumlah,
                                                        qt: cek_stok(res[0].produk[x]
                                                    ...
                                                    data.push({
                                                        id: res[0].produk[x].gudang_barang_jadi[y]
                                                            .id,
                                                        text: nama_var,
                                                        jumlah: res[0].produk[x].pivot.jumlah,
                                                        qt: cek_stok(res[0].produk[x]
                                                ...
                                                $('select[name="variasi[' + w + '][' + x + ']"]').trigger(
                                                    "change");
                                            }
                                        }
                                    });
