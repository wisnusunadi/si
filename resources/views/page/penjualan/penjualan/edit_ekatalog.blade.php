                                            ...
                                            <div class="card-body">
                                                <ul class="nav nav-pills mb-3 nav-justified" id="pills-tab"
                                                    ...
                                                    <li class="nav-item" role="presentation">
                                                        <a class="nav-link active" id="pills-penjualan-tab"
                                                            ...
                                                            aria-controls="pills-penjualan" aria-selected="true">Deskripsi
                                                            Ekatalog</a>
                                                    </li>
                                                    <li class="nav-item" role="presentation">
                                                        <a class="nav-link" id="pills-po-ekat-tab" data-toggle="pill"
                                                            href="#pills-po-ekat" role="tab"
                                                            aria-controls="pills-po-ekat" aria-selected="false">Purchase
                                                            Order</a>
                                                    </li>
                                                    <li class="nav-item" role="presentation">
                                                        <a class="nav-link" id="pills-instansi-tab" data-toggle="pill"
                                                            href="#pills-instansi" role="tab"
                                                    ...
                                                    <li class="nav-item" role="presentation">
                                                        <a class="nav-link disabled" id="pills-pengiriman-tab"
                                                            ...
                                                            aria-controls="pills-pengiriman" data-toggle="pill"
                                                            href="#pills-pengiriman" role="tab"
                                                ...
                                                <div class="form-horizontal">
                                                    <div class="tab-content" id="pills-tabContent">
                                                        ...
                                                        <div class="tab-pane fade show" id="pills-produk" role="tabpanel"
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <td>
                                                            <div class="form-group d-flex justify-content-center">
                                                                ...
                                                                <input type="text" class="form-control produk_harga"
                                                        ...
                                                        <td>
                                                            <div class="form-group d-flex justify-content-center">
                                                                ...
                                                                <input type="text" class="form-control produk_ongkir"
                                                        ...
                                                        <td>
                                                            <div class="form-group d-flex justify-content-center">
                                                                ...
                                                                <input type="text" class="form-control produk_subtotal"
                                                                    name="produk_subtotal[{{ $produkpenjualan }}]"
                                                                    id="produk_subtotal{{ $produkpenjualan }}"
                                                                    placeholder="Masukkan Subtotal" style="width:100%;"
                                                                    value="{{ number_format($f['harga'] * $f['jumlah'] + $f['ongkir'], 0, ',', '.') }}"
                                                                    aria-describedby="prdsub" readonly />
                                                            </div>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <div class="form-group d-flex align-items-center">
                                                                <input type="checkbox" class="stok_distributor"
                                                            ...
                                                            <input type="hidden"
                                                                ...
                                                                class="noSeriDistributor" value="{{ $f['seri'] }}">
                                                        </td>
                                                        <td hidden>
                                                            <input type="hidden" class="rencana_id"
                                                                name="rencana_id[{{ $produkpenjualan }}]"
                                                                id="rencana_id{{ $produkpenjualan }}" readonly
                                                                value="{{ $f['detail_rencana_penjualan_id'] }}">
                                                        </td>
                                                        <td>
                                                            <a id="removerowproduk"><i class="fas fa-minus"
                                                                    style="color: red"></i></a>
                                                        </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="form-group select_item">
                                                                    <select name="penjualan_produk_id[0]" id="0"
                                                                        class="select2 form-control custom-select penjualan_produk_id @error('penjualan_produk_id') is-invalid @enderror"
                                                                        style="width:100%;">
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div class="form-group d-flex justify-content-center">
                                                                    <div class="input-group">
                                                                        <input type="number"
                                                                            class="form-control produk_jumlah"
                                                                            aria-label="produk_satuan"
                                                                            name="produk_jumlah[]" id="produk_jumlah"
                                                            ...
                                                            <td>
                                                                <div class="form-group d-flex justify-content-center">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        name="produk_harga[0]" id="produk_harga0"
                                                                        placeholder="Masukkan Harga" style="width:100%;"
                                                                        aria-describedby="prdhrg" value="" />
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-group d-flex justify-content-center">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        name="produk_ongkir[0]" id="produk_ongkir0"
                                                                        placeholder="Masukkan Ongkir" style="width:100%;"
                                                                        aria-describedby="prdhrg" value="" />
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-group d-flex justify-content-center">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        name="produk_subtotal[0]" id="produk_subtotal0"
                                                            ...
                                                            <td>
                                                                <div class="custom-control custom-switch">
                                                                    <input type="checkbox"
                                                                        class="custom-control-input custom-control-input-pajak produk_ppn"
                                                                        id="produk_ppn0" name="produk_ppn[0]"
                                                                        value="1" checked>
                                                                    <label
                                                                        class="custom-control-label custom-control-label-pajak produk_ppn_label"
                                                            ...
                                                            <td>
                                                                <div class="form-group d-flex align-items-center">
                                                                    <input type="checkbox" class="stok_distributor"
                                                                        name="stok_distributor[0]" id="stok_distributor0"
                                                                        value="0" style="width:100%;" />
                                                                </div>
                                                                <button type="button"
                                                                    class="btn btn-sm btn-outline-primary btnNoSeri"
                                                                    hidden>No Seri</button>
                                                                <input type="hidden" name="noSeriDistributor[0]"
                                                            ...
                                                            <td hidden><input type="hidden" class="rencana_id"
                                                                    name="rencana_id[]" id="rencana_id0" readonly></td>
                                                            <td>
                                                                <a id="removerowproduk"><i class="fas fa-minus"
                                                                        style="color: red"></i></a>
                                                            </td>
                                                                ...
                                                                <div class="form-group d-flex justify-content-center">
                                                                    <div class="input-group">
                                                                        <input type="number"
                                                                            class="form-control produk_jumlah"
                                                                            aria-label="produk_satuan"
                                                                            name="produk_jumlah[0]" id="produk_jumlah0"
                                                                            style="width:100%;" value="">
    ...
    <script>
                    ...
                    success: function(response) {
                        ...
                        swal.fire(
                            ...
                            window.location.href =
                                '/penjualan/penjualan/edit_ekatalog/' +
                                {{ $e->id }} + '/ekatalog';
                            window.location.href =
                                '/penjualan/penjualan/edit_ekatalog/' +
                                {{ $e->id }} + '/ekatalog';
        ...
        $(function() {
                    ...
                    $('#customer_id').select2({
                                ...
                                $.ajax({
                                        ...
                                        success: function(data) {
                                            ...
                                            if ($('input[type="radio"][name="pilihan_pengiriman"]:checked').val() ==
                                                'distributor') {
                                                if ($('input[type="radio"][name="pilihan_pengiriman"]:checked')
                                                    .val() ==
                                                    'distributor') {
                            ...
                            fetch('/api/customer/select/' + $('#customer_id').val()) fetch('/api/customer/select/' + $(
                                '#customer_id').val())
