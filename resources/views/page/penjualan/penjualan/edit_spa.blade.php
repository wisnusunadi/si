                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-7">
                                                                <input type="text" class="d-none"
                                                                    id="c_produk"value="{{ count($e->pesanan->detailpesanan) }}" />
                                                                <input type="text" class="d-none"
                                                                    id="c_part"value="{{ $e->pesanan->getJumlahPesananNonJasa() }}" />
                                                            </div>
                                                        </div>
                                                        {{-- <div class="form-group row">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-6 col-md-12 col-form-label">
                                                                        ...
                                                                        <input value="{{ $e->pesanan->tujuan_kirim }}"
                                                                            type="text"
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <div
                                                                                            class="custom-control custom-switch">
                                                                                            <input type="checkbox"
                                                                                                class="custom-control-input custom-control-label-pajak produk_kalibrasi"
                                                                                                id="produk_kalibrasi0"
                                                                                                name="produk_kalibrasi[0]"
                                                                                                value="0">
                                                                                            <label
                                                                                                class="custom-control-label produk_kalibrasi_label"
