                    ...
                    <div class="col-12">
                        <div class="row">
                            <div class="col-4">
                                ...
                                <div id="nama_customer"><b>{{$e->customer->nama}}</b></div>
                                <div id="alamat"><b>{{$e->customer->alamat}}</b></div>
                                <div id="provinsi"><b>{{$e->customer->provinsi->nama}}</b></div>
                                <div id="telepon"><b>{{$e->customer->telp}}</b></div>
                            </div>
                            <div class="col-1"></div>
                            <div class="col-2">
                                <div>
