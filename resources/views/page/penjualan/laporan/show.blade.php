        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    @elseif(Auth::user()->Karyawan->divisi_id == '15')
                                    ...
                                    <form id="filter">
                                        <div class="form-horizontal">
                                            <div class="form-group row">
                                                <label for=""
                                                    class="col-form-label col-lg-5 col-md-12 labelket">Distributor /
                                                    Customer</label>
                                                <div class="col-lg-4 col-md-12">
                                                    <select class="select2 select-info form-control customer_id"
                                                        name="customer_id" id="customer_id">
                                                        <option value="semua">Semua Distributor</option>
                                                    </select>
                                                    <div class="feedback" id="msgcustomer_id">
                                                        <small class="text-muted">Distributor / Customer boleh
                                                            dikosongi</small>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="penjualan"
                                                    class="col-form-label col-lg-5 col-md-12 labelket">Penjualan</label>
                                                <div class="col-5 col-form-label">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" id="penjualan"
                                                            value="ekatalog" name="penjualan">
                                                        <label class="form-check-label"
                                                            for="inlineCheckbox1">E-katalog</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" id="penjualan"
                                                            value="spa" name="penjualan">
                                                        <label class="form-check-label" for="inlineCheckbox1">SPA</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" id="penjualan"
                                                            value="spb" name="penjualan">
                                            ...
                                            <div class="form-group row">
                                                <label for="tanggal_mulai"
                                                    class="col-form-label col-lg-5 col-md-12 labelket">Tanggal Awal
                                                    PO</label>
                                                <div class="col-lg-2 col-md-12">
                                                    <input type="date"
                                                        class="form-control col-form-label @error('tanggal_mulai') is-invalid @enderror"
                                                        id="tanggal_mulai" name="tanggal_mulai" readonly />
                                            ...
                                            <div class="form-group row">
                                                <label for="tanggal_akhir"
                                                    class="col-form-label col-lg-5 col-md-12 labelket">Tanggal Akhir
                                                    PO</label>
                                                <div class="col-lg-2 col-md-12">
                                                    <input type="date"
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <a id="exportbutton" data-toggle="modal" data-target="#laporanmodal"
                                    class="laporanmodal">
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content" style="margin: 10px">
                        ...
                        <div class="modal-body px-4" id="laporan">
                            <div class="row row-cols-1 row-cols-md-2 g-4">
                                ...
                                <div class="col my-2">
                                    <div class="card h-100">
                                        <div class="media mx-2 my-auto">
                                            <div class="radio icheck-primary mx-3">
                                                <input id="paket_produk" type="radio" name="jenis_laporan"
                                                    value="paket_produk" class="pilih_laporan" />
                                                <label for="paket_produk"></label>
                                            </div>
                                            <div class="media-body align-middle mr-2">
                                                <h5><b>Paket Produk</b></h5>
                                                <p>Laporan akan ditampilkan berdasarkan Paket Produk dan tidak menampilkan
                                                    variasi</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col my-2">
                                    <div class="card h-100">
                                        <div class="media mx-2 my-auto">
                                            <div class="radio icheck-primary mx-3">
                                                <input id="detail_produk" type="radio" name="jenis_laporan"
                                                    value="detail_produk" class="pilih_laporan" />
                                                <label for="detail_produk"></label>
                                            </div>
                                            <div class="media-body align-middle mr-2">
                                                <h5><b>Detail Produk</b></h5>
                                                <p>Laporan akan ditampilkan berdasarkan Paket Produk dan menampilkan variasi
                                                    warna dll</p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="radio icheck-primary mx-3">
                                <input id="seri" type="checkbox" name="tambahan" value="seri"
                                    class="pilih_laporan" />
...
@section('adminlte_js')
    ...
    <script>
        $(function() {
            ...
            $('#semuatable').DataTable({
                ...
                rowGroup: {
                    startRender: function(rows, group) {
                        ...
                        //console.log(group);
                        return $('<tr/>')
                            .append('<td class="tes" colspan="1"><p style="font-weight:50;">' + group +
                                '</td>');
                    },
                    endRender: function(rows, group) {
                        ...
                        totalPenjualan = $.fn.dataTable.render.number(',', '.', 2).display(
                            totalPenjualan);
                        return $('<tr/>')
                            .append('<td colspan="12">Total Penjualan Produk: ' + rows.count() +
                                '</td>')
            ...
            $(document).on('click', '#laporanmodal #btn-export', function(event) {
                ...
                window.location.href = '/penjualan/penjualan/export/' + x + '/' + customer_id + '/' +
                    tanggal_mulai + '/' + tanggal_akhir + '/' + y + '/' + jenis_laporan;
                setTimeout(function() {
                    $("#laporanmodal").modal('hide');
                    $('#loader').fadeOut();
                }, 2000);
                $.ajax({
                        url: '/penjualan/penjualan/export/' + x + '/' + customer_id + '/' +
                            tanggal_mulai + '/' + tanggal_akhir + '/' + y + '/' + tampilan_export,
                        type: 'GET',
                        responseType: 'blob',
                        beforeSend: function() {
                            $('#loader').show();
                        ...
                        error: function(jqXHR, testStatus, error) {
                            console.log(error);
                            alert("Page " + '/penjualan/penjualan/export/' + x + '/' + customer_id +
                                '/' + tanggal_mulai + '/' + tanggal_akhir + '/' + y + '/' +
                                tampilan_export +
                                " cannot open. Error:" + error);
                            $('#loader').hide();
                        },
            ...
            $('.customer_id').on('keyup change', function() {
                if ($(this).val() != "") {
                    if ($('#tanggal_mulai').val() != "" && $('#tanggal_akhir').val() != "" && $(
                            'input[name=penjualan]:checked').length > 0) {
            ...
            $('#filter').submit(function() {
                ...
                $('#semuaform').removeClass('hide');
                $('#semuatable').DataTable().ajax.url('/api/laporan/penjualan/' + x + '/' + customer_id +
                    '/' + tanggal_mulai + '/' + tanggal_akhir).load();

                var link = '/penjualan/penjualan/export/' + x + '/' + customer_id + '/' + tanggal_mulai +
                    '/' + tanggal_akhir + '/' + y + '/' + tampilan_export;
    ...
    <script>
        $(document).ready(function() {
            $('[data-toggle="tooltip_merge"]').tooltip({
                content: '<img src="{{ url('assets/image/tooltip/merge.png') }}" />'
            });
            $('[data-toggle="tooltip_unmerge"]').tooltip({
                content: '<img src="{{ url('assets/image/tooltip/unmerge.png') }}" />'
            });
        });
    </script>
