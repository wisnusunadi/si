...
@section('content')
                        ...
                        <div class="card-body">
                            <ul class="nav nav-pills mb-5" id="pills-tab" role="tablist">
                                ...
                                <a class="nav-link" id="pills-batal_po-tab" data-toggle="pill" href="#pills-batal_po" role="tab" aria-controls="pills-batal_po" aria-selected="false">Batal Proses</a>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="pills-rekap_produk-tab" data-toggle="pill"
                                            href="#pills-rekap_produk" role="tab" aria-controls="pills-rekap_produk"
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                @if (Auth::user()->divisi_id !== 31)
                                    ...
                                    <div class="tab-pane fade show" id="pills-batal_po" role="tabpanel"
                                        aria-labelledby="pills-batal_po-tab">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="table-responsive">
                                    ...
                                    <div class="tab-pane fade show" id="pills-rekap_produk" role="tabpanel"
                                        aria-labelledby="pills-rekap_produk-tab">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered" style="width: 100%"
                                ...
                                @else
                                    <div class="tab-pane fade show active" id="pills-batal_po" role="tabpanel"
                                        aria-labelledby="pills-batal_po-tab">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="table-responsive">
    ...
    <div class="modal fade" id="viewDetailBrg" data-backdrop="static" data-keyboard="false" tabindex="-1"
                            ...
                            <table class="table table-striped" id="reakpdetail-produk">
                                <thead>
                                    <tr align="center">
                                        ...
                                        <th rowspan="2" style="vertical-align : middle;text-align:center;">Customer
                                        </th>
    ...
    <div class="modal fade" id="viewDetailBrgSO" data-backdrop="static" data-keyboard="false" tabindex="-1"
        aria-labelledby="" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                                    ...
                                    <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="tabs-produk-tab" data-toggle="pill"
                                                ...
                                                aria-selected="false">Detail Pembatalan</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="card-body">
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="info-box bg-maroon">
                                                        ...
                                                        <div class="info-box-content">
                                                            ...
                                                            <span class="info-box-number" id="noso">SO
                                                                1234</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="info-box bg-warning">
                                                        ...
                                                        <div class="info-box-content">
                                                            ...
                                                            <span class="info-box-number" id="nopo">PO
                                                                1234</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="info-box bg-olive">
                                                        ...
                                                        <div class="info-box-content">
                                                            ...
                                                            <span class="info-box-number" id="cust">PT
                                                                Emiindo Jaya</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="info-box bg-indigo" style="box-shadow: none">
                                                        ...
                                                        <div class="info-box-content">
                                                            ...
                                                            <span class="info-box-number" id="tglbatal">18
                                                                September 2022</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="info-box bg-danger">
                                                        <span class="info-box-icon"><i
                                                                class="fas fa-exclamation-triangle fa-fw"></i></span>
                                                        <div class="info-box-content">
                                                            <span class="info-box-text" id="spanAlasan">Alasan
                                                                Batal</span>
...
@section('adminlte_js')
    <script>
            ...
            $("#head-cb-so").on('click', function() {
                ...
                table.rows().every(function() {
                    if (this.data().status ==
                        ...
                        this.nodes().to$().find('input[type="checkbox"]').prop('checked', $(
                            '#head-cb-so').prop(
                            'checked'));
                    }
                });
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return `
                                        <button class="btn btn-sm btn-outline-info buttonShowSeri" data-id="${data.id}"><i class="fa fa-info-circle"></i> Detail No. Seri Produk</button>
                                    `
                        }
                    }
                ],
                ...
                "drawCallback": function(settings) {
                    ...
                    api.column(0, {
                        ...
                        if (last !== group) {
                            ...
                            $(rows).eq(i).before(
                                '<tr class="table-dark text-bold"><td style="display:none;">' +
                                group + '</td><td colspan="3">' + rowData.paket +
                                '</td></tr>'
                            );
                            last = group;
                        }
        ...
        $(document).on('click', '.buttonShowSeri', function(e) {
            ...
            // show modal
            $('#modaldetailserisudahproses').modal('show');
        })
    </script>
@stop
