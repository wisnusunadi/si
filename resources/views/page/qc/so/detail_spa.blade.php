    ...
    <div class="d-flex bd-highlight">
        ...
        <div class="p-2 bd-highlight">
            <ol class="breadcrumb float-sm-right">
                ...
                @endif
                <li class="breadcrumb-item"><a href="/qc/so">Sales Order QC</a></li>
...
@section('content')
    ...
    <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="d-flex bd-highlight">
                                        ...
                                        <div class="p-2 bd-highlight">
                                            @if (Auth::user()->divisi_id == '23')
                                                <span class="filter">
                                                    <a class="editmodal" data-attr="" data-id="">
        ...
        <!-- Modal -->
        <div class="modal fade" id="modalKalibrasi" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
            <div class="modal-dialog modal-xl" role="document">
    ...
    <script>
        $(function() {
            ...
            $(document).on('click', '.btnKalibrasi', function(event) {
                ...
                //         $('#modalKalibrasi').modal("show");
                //         $('#kalibrasi').html(result).show();
                //         if (datajenis == "produk") {
                //             if (checkedKalibrasi.length == 0) {
                //                 listnoserikalibrasi("kosong", data, '{{ $id }}');
                //             } else {
                //                 listnoserikalibrasi(checkedKalibrasi, data,
                //                     '{{ $id }}');
                //             }
                //         }
                //         max_date();
            ...
            const isListNoseriEmpty = () => {
                const listnoseri = $('#listnoseri').DataTable();
                const test = listnoseri.rows().count() > 0 ? false : true;
                return test;
            }

            // validasi detail pengujian
            $(document).on('click', 'input[type="radio"][name="cek"]:checked', function(event) {
