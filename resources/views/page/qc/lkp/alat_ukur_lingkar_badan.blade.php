                ...
                <table class="table mdtxt" width=100%>
                    <tbody class="vera">
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>Pengujian Alat Ukur Lingkar Badan</td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <table width=100% class="vera">
                                    ...
                                    <tr>
                                        ...
                                        <td class="nospace">:</td>
                                        <td class="wb vera">Pita Pengukur Lingkar Badan</td>
...
<div class="card">
    <div class="card-body">
        <div>E.Pengukur Lingkar Badan</div>
                        <table border="1" style="border-collapse: collapse;text-align:center;" width="100%">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="nospace" rowspan="4">3 mm</td>
                                </tr>
                                <tr>
                                    <td class="nospace">2</td>
                                    <td class="nospace">360</td>
