    ...
    methods: {
        async getData() {
            try {
                ...
                const { data: dalamProses } = await axios.get(
                    `/api/logistik/so/data/${this.jenisDalamProsesStatus}/${this.$store.state.years}`
                );
                ...
                const { data: selesaiProses } = await axios.get(
                    `/api/logistik/so/data/selesai/${this.$store.state.years}`
                );
                ...
                const { data: batalPO } = await axios.get(
                    `/api/penjualan/batal_po/logistik/show`
                );
