...
export default {
  ...
  computed: {
    comment_filter: function () {
      return this.comment.filter((i) => i.komentar !== null);
    },
  },
            ...
            >
              <td>
                <i
                  ...
                  "
                ></i>
                {{ `${item.produk.produk.nama_coo} ${item.produk.nama}` }}
              </td>
              <td>{{ item.jumlah }}</td>
            </tr>
          </tbody>
    ...
    <div class="card">
      ...
      >
        <table id="table-komentar" class="table table-hover">
          ...
          <tbody>
            <tr v-for="komen in comment_filter" :key="komen.id">
              <td>{{ komen.tanggal_hasil }}</td>
              <td>
                {{
                  convertState(state_id[komen.state]) +
                  " " +
