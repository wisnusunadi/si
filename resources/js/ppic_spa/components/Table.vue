...
export default {
  ...
  async created() {
    ...
    if (this.status === "pelaksanaan") {
      await axios
        .get("/api/ppic/data/rencana_perakitan", {
          headers: {
            Authorization: "Bearer " + localStorage.getItem("lokal_token"),
          },
        })
  ...
  methods: {
    ...
    async changeProduk() {
      ...
      await axios
        .get(
          "/api/ppic/data/gbj?id=" + this.produk.value,
          {
            headers: {
              Authorization: "Bearer " + localStorage.getItem("lokal_token"),
            },
      ...
      await axios
        .get(
          "/api/ppic/data/gk/unit?id=" + this.produk.value,
          {
            headers: {
              Authorization: "Bearer " + localStorage.getItem("lokal_token"),
            },
        ...
        <section class="modal-card-body">
          ...
          <div class="field is-horizontal">
            ...
            <div class="field-body">
              <div class="field">
                <div class="control">
                  <div>Produksi : {{ produksi_stok }}</div>
