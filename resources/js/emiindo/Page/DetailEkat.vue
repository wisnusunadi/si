        ...
        <section class="content" v-else>
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="card" id="ekatalog" v-if="
                                    ...
                                    <div class="col-lg-11 col-md-12">
                                        <div class="row d-flex justify-content-between">
                                            ...
                                            <div class="p-2">
                                                ...
                                                <div class="margin">
                                                    <div>
                                                        <small class="text-muted">No AKN</small>
                                                    </div>
                                                    <div>
                                                        <b>{{ ekat.epurno }}</b>
                                                    </div>
                                                ...
                                                <div class="margin">
                                                    <div>
                                                        <small class="text-muted">Tanggal Batas
                                                            Kontrak</small>
                                                    </div>
                                                    <div><b>-</b></div>
                                                </div>
                                                    ...
                                                    <div v-if="
                                                        ...
                                                        <span v-if="
                                                                forminfoakn
                                                                    ...
                                                                    .status ==
                                                                'sepakat'
                                                            " class="badge green-text">Sepakat</span>
                                                        <span v-else-if="
                                                                forminfoakn
                                                                    .deskripsi
                                                                    .status ==
                                                                'negosiasi'
                                                            " class="badge warning-text">Negosiasi</span>
                                                        <span v-else-if="
                                                                forminfoakn
                                                                    .deskripsi
                                                                    .status ==
                                                                'batal'
                                                            " class="badge danger-text">Batal</span>
                                                    </div>
                                                    <div class="badge green-text" v-else>
                                                        Sepakat
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="p-2">
                                                ...
                                                <div class="margin">
                                                    <div>
                                                        <small class="text-muted">Tanggal PO</small>
                                                    </div>
                                                    <div>
                                                        <b v-if="po == null">-</b>
                                                        <b v-else>{{
                                                ...
                                                <div class="margin">
                                                    <div>
                                                        <small class="text-muted">No DO</small>
                                                    </div>
                                                    <div>
                                                        <b v-if="Do == null">-</b>
                                                        <b v-else>{{
                                                ...
                                                <div class="margin">
                                                    <div>
                                                        <small class="text-muted">Tanggal DO</small>
                                                    </div>
                                                    <div>
                                                        <b v-if="Do == null">-</b>
                                                        <b v-else>{{
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="content">
                                    <form method="post">
                                        <div class="row d-flex justify-content-center" id="akn" v-if="
                                                        ...
                                                        <ul class="nav nav-pills mb-3 nav-justified" id="pills-tab"
                                                            ...
                                                            <li class="nav-item" role="presentation">
                                                                <a class="nav-link active" id="pills-penjualan-tab"
                                                                    data-toggle="pill" href="#pills-penjualan"
                                                                    role="tab" aria-controls="pills-penjualan"
                                                                    @click="tab = 'deskripsi'"
                                                        ...
                                                        <div class="form-horizontal">
                                                            <div class="tab-content" id="pills-tabContent">
                                                                <div class="tab-pane fade show active"
                                                                    id="pills-penjualan" role="tabpanel"
                                                                    aria-labelledby="pills-penjualan-tab"
                                                                    v-show="tab = 'deskripsi'"
                                                                    >
                                                                    ...
                                                                    <div class="card removeshadow">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div
                                                                                    class="col-lg-7 col-md-12 autocomplete">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-lg-7 col-md-12">
                                                                                    <input type="text"
                                                                                        class="form-control col-form-label ui-autocomplete-input"
                                                                                        name="satuan_kerja"
                                                                                        id="satuan_kerja" v-model="
                                                                                            forminfoakn
                                                                                                .instansi
                                                                                                .satuankerja
                                                                                        " autocomplete="off" />
                                                                                    <div class="invalid-feedback"
                                                                                        id="msgsatuan_kerja"></div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label for=""
                                                                                ...
                                                                                <div class="col-lg-7 col-md-12">
                                                                                    <textarea
                                                                                        ...
                                                                                        name="alamatinstansi"
                                                                                        id="alamatinstansi"
                                                                                        autocomplete="off" v-model="
                                                                                            forminfoakn
                                                                                                .instansi
                                                                                                .alamat
                                                                                        "></textarea>
                                                                                    <div class="invalid-feedback"
                                                                                        id="msgalamatinstansi"></div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label for=""
                                        ...
                                        <div class="row d-flex justify-content-center" id="nonakn" v-else>
                                            <div class="col-lg-11 col-md-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                            ...
                                                            <div class="col-5 col-form-label">
                                                                <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        ...
                                                                        ref="checkboxproduk" checked @change="
                                                                            getBarang
                                                                        " />
                                                                    <label class="form-check-label"
                                                                ...
                                                                <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        ...
                                                                        name="jenis_pen[]" ref="checkboxsparepart"
                                                                        @change="
                                                                            getBarang
                                                                        " />
                                                                    <label class="form-check-label"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-4 col-md-12">
                                                                <input type="text" class="form-control col-form-label"
                                                                    id="no_po" name="no_po" v-model="
                                                                        formpenjualanpo
                                                                            .po
                                                                            .nomorpo
                                                                    " />
                                                                <div class="invalid-feedback" id="msgno_po"></div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label for=""
                                                            ...
                                                            <div class="col-lg-4 col-md-12">
                                                                <input type="date" class="form-control col-form-label"
                                                                    id="tanggal_po" name="tanggal_po" v-model="
                                                                        formpenjualanpo
                                                                            .po
                                                                            .tgl_po
                                                                    " :max="
                                                                        datemax
                                                                    " />
                                                                <div class="invalid-feedback" id="msgtanggal_po"></div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label for=""
                                                            ...
                                                            <div class="col-lg-5 col-md-12 col-form-label">
                                                                <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="do" id="yes" value="yes" v-model="
                                                                            formpenjualanpo
                                                                                .do
                                                                                .status
                                                                        " />
                                                                ...
                                                                <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="do" id="no" value="no" v-model="
                                                                            formpenjualanpo
                                                                                .do
                                                                                .status
                                                                        " />
                                                        ...
                                                        <div v-show="
                                                                ...
                                                                'yes'
                                                            ">
                                                            <div class="form-group row" id="do_detail_no">
                                                                <label for=""
                                                                    class="col-form-label col-lg-5 col-md-12 labelket">Nomor
                                                                    DO</label>
                                                                <div class="col-lg-4 col-md-12">
                                                                    <input type="text"
                                                                        class="form-control col-form-label" id="no_do"
                                                                        name="no_do" v-model="
                                                                            formpenjualanpo
                                                                                .do
                                                                                .nomordo
                                                            ...
                                                            <div class="form-group row" id="do_detail_tgl">
                                                                <label for=""
                                                                    class="col-form-label col-lg-5 col-md-12 labelket">Tanggal
                                                                    DO</label>
                                                                <div class="col-lg-4 col-md-12">
                                                                    <input type="date"
                                                                        class="form-control col-form-label"
                                                                        id="tanggal_do" name="tanggal_do" :min="
                                                                            datemax
                                                                        " v-model="
                                                                            formpenjualanpo
                                                                                .do
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-5 col-md-12">
                                                                    <textarea class="form-control col-form-label"
                                                                        id="nonketerangan" name="keterangan" v-model="
                                                                            formpenjualanpo
                                                                                .do
                                                                                .keterangan
                                                                        "></textarea>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="keterangan"
                                                                    class="col-form-label col-lg-5 col-md-12 labelket">Ekspedisi</label>
                                                                <div class="col-lg-5 col-md-12">
                                                                    <input type="text"
                                                                        class="form-control col-form-label" id="no_do"
                                                                        name="no_do" v-model="
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="card" v-if="
                                                            ...
                                                            <div class="card-body">
                                                                <table class="table tableprodukemiindo">
                                                                    <thead>
                                                                        <tr>
                                                                            <th>
                                                                                No
                                        ...
                                        <div class="row d-flex justify-content-center">
                                            <div class="col-lg-11 col-md-12">
                                                <span>
                                                    <router-link :to="{ name: 'Index' }" class="btn btn-danger">Batal
                                                    </router-link>
                                                </span>
                                                <span class="float-right">
                                                    <button type="button" class="btn btn-warning" @click="simpan"
            ...
            infoakn() {
                this.forminfoakn = {
                    ...
                    instansi: {
                        ...
                        provinsi: this.ekat.satuankerja.kota.provinsi.provnm.toUpperCase(),
                                    ...
                                    .then((response) => {
                                        if (response.data.message == "Berhasil") {
                                            ...
                                            try {
                                                ...
                                                axios.post(
                                                    'https://sinko.api.hyperdatasystem.com/api/salesorder/save',
                                                    data, {
                                                        headers: {
                                ...
                                .then((response) => {
                                    if (response.data.status == 200) {
                                        ...
                                        try {
                                            ...
                                            axios.post(
                                                'https://sinko.api.hyperdatasystem.com/api/purchaseorder/save',
                                                data, {
                                                    headers: {
                                                        Authorization: 'Bearer ' + sessionStorage
                                                            .getItem('token')
                                            ...
                                            if (dataPO.no_do != null || dataPO.no_do != "") {
                                                ...
                                                axios.post(
                                                    'https://sinko.api.hyperdatasystem.com/api/deliveryorder/save',
                                                    data, {
                                                        headers: {
                                                            Authorization: 'Bearer ' + sessionStorage
                                                                .getItem('token')
