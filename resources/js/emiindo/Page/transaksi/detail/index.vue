...
import Detailnoseridsb from "./detailnoseridsb.vue";
    ...
    methods: {
        ...
        async getDataProduct() {
            try {
                const { data } = await axios.get(
                    `/api/penjualan/items/${this.detail.pesanan_id}`
                );
                this.paket = data;
            } catch (error) {
                console.error(error);
        ...
        totalHarga() {
            return this.paket.reduce((acc, item) => {
                return (
                    acc + this.subtotal(item.harga, item.ongkir, item.jumlah)
                );
            }, 0);
        },
        ...
        async getChartPengiriman(id, jenis) {
            try {
                const { data } = await axios.get(
                    `/api/get_stok_pesanan?id=${id}&jenis=${jenis}`
                );
                this.pengiriman = data;

                if (jenis == "part") {
                    this.chartData = {
                        labels: ["QC", "Logistik", "Kirim"],
                        datasets: [
                            {
                                backgroundColor: [
                                    "rgb(255, 221, 0)",
                    ...
                    this.chartData = {
                        labels: ["Gudang", "QC", "Logistik", "Kirim"],
                        datasets: [
                            {
                                backgroundColor: [
                                    "rgb(236, 159, 5)",
        ...
        openDetailNoSeri(noseri) {
            this.detailSelected = noseri;
            this.showModal = true;
            $(".modalDetail").modal("hide");
            this.$nextTick(() => {
                $(".modalDetailNoSeriDsb").modal("show");
            });
        },
        closeModalDetailNoSeridsb() {
...
<template>
    <div>
        <Detailnoseridsb
            v-if="showModal"
            :noseri="detailSelected"
            @close="closeModalDetailNoSeridsb"
        />
        <div
                            ...
                            <div class="card-body">
                                ...
                                >
                                    ...
                                    >
                                        <div class="row">
                                            <div
                                                class="card col-lg-4 col-md-12 col-sm-12"
                                                v-if="pengiriman"
                                            >
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        >
                                                            ...
                                                            />
                                                            <div
                                                                class="card card-secondary card-outline mt-3"
                                                            >
                                                                <div
                                                                    class="card-body"
                                                                >
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            <span
                                                                                ...
                                                                                ><span
                                                                                    class="foo bg-chart-orange mr-2"
                                                                                ></span
                                                                                ><span
                                                                                    >Gudang</span
                                                                                ></span
                                                                        ...
                                                                        >
                                                                            <span
                                                                                class="align-self-center"
                                                                                ><span
                                                                                    class="foo bg-chart-yellow mr-2"
                                                                                ></span
                                                                                ><span
                                                                                    >QC</span
                                                                                ></span
                                            ...
                                            >
                                                <div class="card-body">
                                                    ...
                                                    <div
                                                        class="table-responsive overflowcard"
                                                    >
                                                        <table
                                                            class="table"
                                                            style="
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <tr>
                                                                    ...
                                                                    <!-- jika paket ada stok dsb maka tampilkan -->
                                                                    <th
                                                                        rowspan="2"
                                                                        v-if="
                                                                            paket.find(
                                                            ...
                                                            <tfoot
                                                                class="bg-chart-light align-center"
                                                            >
                                                                <tr>
                                                                    <th
                                                                        colspan="6"
