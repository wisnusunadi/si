...
export default {
  ...
  methods: {
    ...
    simpan() {
      ...
      axios
        .put(
          `/api/penjualan/pesanan/update/${this.doData.pesanan_id}/${this.doData.jenis}`,
          this.form
        )
        .then((res) => {
          this.closeModal();
                  ...
                  <div class="card-body">
                    ...
                    <div class="margin">
                      ...
                      <b class="float-right" id="status">
                        <statusComponents
                          :status="
                            doData.jenis == 'ekatalog'
                              ? doData.status
                              : doData.pesanan.state.nama
                          "
                        />
                      </b>
                    </div>
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header">
                      <i class="fas fa-edit"></i> Ubah No Urut
                    </div>
                    <div class="card-body">
                      <div class="form-horizontal">
                        <div
                          class="form-group row"
                          v-if="doData.jenis == 'ekatalog'"
                        >
                          <label
                            for=""
