...
export default {
    ...
    methods: {
        // Function to show the detail of the selected item
        detail(item) {
                            ...
                            <div class="dropdown-menu" style="">
                                <div class="px-3 py-3">
                                    <div class="form-group">
                                        <div
                                            class="form-check"
                                            v-for="(year, key) in yearsComputed"
                                            :key="key"
                                        >
                                            <input
