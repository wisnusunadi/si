...
import perubahan from './perubahan/index.vue';
...
<template>
    <div class="body">
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            ...
            <li class="nav-item" role="presentation"
                v-if="$route.params.jenis == 'Peminjaman' && $route.params.status != 'barangdisiapkan'">
            ...
            <li class="nav-item" role="presentation" v-if="$route.params.jenis == 'Peminjaman' && $route.params.status != 'barangdisiapkan'">
