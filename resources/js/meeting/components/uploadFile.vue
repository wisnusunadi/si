    ...
    methods: {
        ...
        previewImgs(event) {
            ...
            if (
                this.$props.max &&
                event &&
                event.currentTarget.files.length + this.files.length >
                    this.$props.max
            ) {
                this.error = this.$props.maxError
                    ? this.$props.maxError
            ...
            for (let i = 0; i < this.files.length; i++) {
                readers.push(this.readAsDataURL(this.files[i], i));
            }
...
<template>
    ...
    >
        ...
        <div v-show="progress.length == 0" class="beforeUpload">
            <input
                type="file"
                style="z-index: 1"
                ref="uploadInput"
            ...
            <p class="mainMessage">
                {{
                    uploadMsg
                        ? uploadMsg
                        : "Click to upload or drop your files here"
                }}
            </p>
        </div>
