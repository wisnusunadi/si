...
export default {
    ...
    methods: {
        ...
        simpanMeeting() {
            swal.fire({
                title: "Peringatan",
                text: "Apakah anda yakin ingin menyimpan hasil meeting?",
                icon: "warning",
                ...
                if (result.isConfirmed) {
                    this.$emit("simpanMeeting");
                    console.log("simpan meeting");
                }
            });
        }
    },
                ...
                <div class="col-lg-11 col-md-12">
                    <div class="row d-flex justify-content-between">
                        ...
                        <div class="p-2 cust">
                            ...
                            <div class="margin">
                                <b id="distributor">{{
                                    changeFormatDate(meeting.tgl_meeting)
                                    }}</b>
                            </div>
                        ...
                        <div class="p-2">
                            ...
                            <div class="margin">
                                ...
                                <div>
                                    <b id="no_so">{{ meeting.peserta?.length }} Peserta</b>
                                </div>
                            </div>
                        </div>
                        <div class="p-2">
                            <div class="margin">
                                ...
                                <div>
                                    <b id="no_so">
                                        <a @click="$emit('cetakHasilMeet')" target="_blank">
