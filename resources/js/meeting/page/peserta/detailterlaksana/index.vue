    ...
    async getData() {
      try {
        ...
        this.meeting.dokumen_meet = [
          {
            jenis: "foto",
            dokumen: this.groupDocuments(data.kehadiran.dokumen_meet).foto,
          },
          {
            jenis: "video",
            dokumen: this.groupDocuments(data.kehadiran.dokumen_meet).video,
          },
          {
            jenis: "rekaman",
            dokumen: this.groupDocuments(data.kehadiran.dokumen_meet).rekaman,
          },
          {
            jenis: "dokumen",
            dokumen: this.groupDocuments(data.kehadiran.dokumen_meet).dokumen,
          },
        ];
      } catch (error) {
        console.log(error);
