                ...
                <table class="table" id="penjualan_produk">
                  ...
                  <tbody>
                    <!-- <tr>
                      ...
                      <td></td>
                      <td>
                        <span>Rp.</span><span class="float-right">1000000</span>
                      </td>
                      <td>
                ...
                <div class="card">
                  <div class="card-body">
                    <ul class="list-group">
                      ...
                      <li class="list-group-item">
                        <a>Nama Produk</a><span id="nama_produk"></span
                        ><b class="float-right">FOX-BABY + Case</b>
                      </li>
                      <li class="list-group-item">
                        <a>Harga</a><span id="kelompok_produk"></span
                        ><b class="float-right">Rp. 1.000.000,00</b>
                      </li>
                      <li class="list-group-item">
                        <a>Stok</a><span id="stok"></span
                        ><b class="float-right">100</b>
                      </li>
                    </ul>
                  </div>
                </div>
                      ...
                      <div class="row">
                        <div class="col-12">
                          ...
                          >
                            ...
                            <tbody>
                              <tr v-for="(row, index) in rowsedit" :key="index">
                                <td>
                                  {{ index + 1 }}
                                </td>
                                <td>
