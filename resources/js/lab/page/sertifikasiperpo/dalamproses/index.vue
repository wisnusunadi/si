...
export default {
    ...
    data() {
        return {
            ...
            headers: [
                ...
                { text: "Nama Pemilik", value: "pemilik" },
                { text: "Nama Pemilik Sertifikat", value: "pemilik_sertif" },
    ...
    methods: {
        ...
        async getDalamProses() {
            try {
                this.$store.dispatch("setLoading", true);
                const { data } = await axios.get("/api/labs/data/sebagian");
        ...
        detail(id) {
            this.$router.push({
                ...
                params: { id: id, history: this.$route.path }
            });
        },
    },
    computed: {
