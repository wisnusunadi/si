...
Route::group(['prefix' => 'qc', 'middleware' => 'auth'], function () {
    Route::group(['middleware' => ['divisi:qc']], function () {
        ...
        Route::view('/monitoring_kalibrasi/{any?}', 'page.lab.kalibrasi_new')->where('any', '.*');
        Route::view('/riwayatTransfer/{any?}', 'page.lab.kalibrasi_new')->where('any', '.*');
        Route::view('/transfer/{any?}', 'page.lab.kalibrasi_new')->where('any', '.*');
    });
    Route::group(['prefix' => '/so'], function () {
        ...
        Route::group(['middleware' => ['divisi:qc']], function () {
            ...
            Route::get('/kalibrasi/{jenis}/{produk_id}/{pesanan_id}', [App\Http\Controllers\QcController::class, 'get_data_seri_detail_ekatalog_kalibrasi'])->name('qc.so.edit');
...
Route::group(['prefix' => '/labs'], function () {
    Route::get('/data/',  [App\Http\Controllers\LabController::class, 'bom_detail'])->name('teknik.bom.detail');
