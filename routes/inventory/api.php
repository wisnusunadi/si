...
Route::prefix('/inventory')->group(function() {
    ...
    Route::get('get_data_pj/{x}', [AlatujiController::class, 'get_data_pj']);
    ...
    route::get('get_data_target/{x}', [AlatujiController::class, 'get_data_target']);
});
...
Route::prefix('/kalibrasiperbaikan')->group(function(){
    ...
    Route::get('/get_data_perusahaan/{x}', [KalibrasiPerbaikanController:: class, 'get_data_perusahaan']);
});
